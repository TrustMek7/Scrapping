...
// ../../node_modules/.pnpm/react-router@7.18.2_react-d_ebd9f6aaf916bfadf05eff1070ce6f8a/node_modules/react-router/dist/development/chunk-62JRHF6Z.mjs
...
function createBrowserURLImpl(windowImpl, to, isAbsolute = false) {
  ...
  if (!isAbsolute && PROTOCOL_RELATIVE_URL_REGEX.test(href2)) {
    href2 = base + href2;
  }
...
function RSCErrorHandler({
  ...
  if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
    ...
    if (redirect2) {
      ...
      return React2.createElement("meta", { httpEquiv: "refresh", content: `0;url=${target}` });
    }
  }
  return children;
}
...
function useRouterState() {
  ...
  let active = React2.useMemo(
    () => {
      ...
      return {
        ...
        params: ((_a = matches[matches.length - 1]) == null ? void 0 : _a.params) ?? {},
  ...
  let pending = React2.useMemo(() => {
    ...
    let shared = {
      ...
      params: ((_a = navigation.matches[navigation.matches.length - 1]) == null ? void 0 : _a.params) ?? {},
...
function ScrollRestoration({
  ...
  if (props.nonce == null && (remixContext == null ? void 0 : remixContext.nonce)) {
...
function encodeLocation(to) {
  let href2 = typeof to === "string" ? to : createPath(to);
  href2 = href2.replace(/ $/, "%20");
  let encoded = ABSOLUTE_URL_REGEX.test(href2) ? new URL(href2) : new URL(href2, "http://localhost");
  return {
...
// ../../node_modules/.pnpm/react-router@7.18.2_react-d_ebd9f6aaf916bfadf05eff1070ce6f8a/node_modules/react-router/dist/development/chunk-ZA36QIGN.mjs
    ...
    if (routerRef.current == null) {
      frameworkContextRef.current = {
        future: {
          ...
          v8_trailingSlashAwareDataRequests: (future == null ? void 0 : future.v8_trailingSlashAwareDataRequests) === true
        },
        manifest: {
          routes: {},
...
function getNormalizedPath(request, basename, future) {
  ...
  if (future == null ? void 0 : future.v8_trailingSlashAwareDataRequests) {
...
react-router/dist/development/chunk-ZA36QIGN.mjs:
